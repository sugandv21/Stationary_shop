...
import banner from "../assets/images/school_banner.jpg";
import addedToCartImg from "../assets/images/added_to_cart.png";
import { schoolSuppliesProducts } from "../data/schoolSuppliesData";
...
const SchoolSupplies = () => {
    useEffect(() => {
              document.title = "Supplyhive | School Supplies";
            }, []); 
  const [selectedPrices, setSelectedPrices] = useState([priceFilters[0].label]);
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [addedProduct, setAddedProduct] = useState(null);
  const [selectedCategory, setSelectedCategory] = useState("School Supplies");
  ...
  const filteredProducts = schoolSuppliesProducts.filter((p) => {
  ...
  return (
    <div className="min-h-screen">
        ...
        <p className="text-center mt-10 text-lg md:text-2xl font-semibold text-gray-700">
