...
import banner from "../assets/images/file&folders_banner.jpg";
...
const File = () => {
   useEffect(() => {
          document.title = "Supplyhive | Files & Folders";
        }, []); 
  const [selectedPrices, setSelectedPrices] = useState([priceFilters[0].label]);
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [addedProduct, setAddedProduct] = useState(null);
  const [selectedCategory, setSelectedCategory] = useState("Files & Folders");
