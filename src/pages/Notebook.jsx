...
import banner from "../assets/images/paper&notebook_banner.jpg";
...
const Notebook = () => {
   useEffect(() => {
          document.title = "Supplyhive | Paper & Notebooks";
        }, []); 
  const [selectedPrices, setSelectedPrices] = useState([priceFilters[0].label]);
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [addedProduct, setAddedProduct] = useState(null);
  const [selectedCategory, setSelectedCategory] = useState("Paper & Notebooks");
